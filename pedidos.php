...
<html lang="pt">
  ...
  while($dados_pedidos = mysqli_fetch_array($resultado_pedidos)){
    ...
    $email_painel_cliente=$dados_pedidos['email_painel'];
    ?>
  ...
  <table width="80%" border="0">
    ...
    <tr>
      <td colspan="2"><div align="center"><?php echo "$telefone_cliente <b>$nome_cliente</b>";?> </div></td>
    </tr>
    <tr>
      ...
      <td>
        <label>
          <div align="center">
            ...
            <input type="submit" name="aceitar" id="button" value="ACEITAR" formaction="aceitar.php"  />
          </div>
        </label>
      </td>
      <td>
