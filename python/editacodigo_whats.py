...
def carregar_pagina_whatsapp(session_directory, site):
    ...
    # CORRIGIDO: uso correto do Service
...
def pega_contato(driver, contato_cliente):
    ...
    print("Telefone original:", telefone_final)

    # Remove caracteres +, -, espaços e parênteses
    telefone_final = ''.join(filter(str.isdigit, telefone_final))
    print("Telefone sanitizado:", telefone_final)
